...
function SingInSingUp(props){
  return(
  <Box>
  <Link href="/singin"style={{ marginRight: 10 }} variant="button" color="inherit">SingIn</Link>
  <Link href="/singup"  variant="button" color="inherit">SingUp</Link>
  </Box>
  );
}
      ...
      <AppBar position="static">
        <Toolbar>
          ...
          <Typography className={classes.title} variant="h6" noWrap>
           <Link href="/" style={{color:"whitesmoke"}} > bOokBeEz</Link>
          </Typography>
